...
This is a simple, full stack Node.js application using React, Express and MySQL. 

The purpose of the application is to be used as a starting point to begin building a new full stack React application with MySQL as the database solution. The repository can be cloned and configured to save the time normally required to set up the foundational code required for a functioning MERN application.
